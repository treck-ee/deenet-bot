...
// ---------- ВЕБХУК ЭНДПОИНТ (используем приватный метод с игнорированием ошибки TS) ----------
app.post('/webhook', async (req, res) => {
  console.log('📨 Webhook received');
  try {
    // @ts-ignore - метод handleUpdate приватный, но мы знаем, что он работает
...
// Активируем бота (не обязательно для вебхука, но может инициализировать что-то внутри)
